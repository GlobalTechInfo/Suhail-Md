...
//═══════[Required Variables]════════\\
global.audio= "" ;  
global.video= "https://f.uguu.se/znDxwNjU.mp4" ;
...
global.caption = process.env.CAPTION || global.caption || "𝗞𝗛𝗔𝗥𝗔𝗟-𝗠𝗗-𝗩𝟱" 
...
module.exports = {
  ...
  caption : global.caption || "" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ *GlobalTechInfo* 』```", //*『sᴜʙsᴄʀɪʙᴇ • GlobalTechInfo』*\n youtube.com/@GlobalTechInfo"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "𝗞𝗛𝗔𝗥𝗔𝗟-𝗠𝗗",
  ...
  LANG: ( process.env.THEME ||  "KHARAL"  ).toUpperCase(),
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  //style : process.env.STYLE || "",  // put '1' & "2" here to check bot styles
